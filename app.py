...
.head {{ border-bottom:1px solid #D6D0C0; padding:0 0 1.15rem; margin:0 0 1.5rem; }}
.head .kicker {{ font-family:'Space Mono',monospace; font-size:.68rem !important;
  letter-spacing:.18em; text-transform:uppercase; color:#7C776B; margin:0; }}
.head .title {{ font-family:'Work Sans',sans-serif; font-weight:600;
  font-size:2.5rem !important; line-height:1.16 !important; letter-spacing:-.022em;
  color:{INK}; margin:.4rem 0 0; }}
.head .meta {{ font-family:'Space Mono',monospace; font-size:.72rem !important;
  letter-spacing:.13em; text-transform:uppercase; color:#7C776B; margin:.65rem 0 0; }}
...
.eyebrow {{ font-family:'Space Mono',monospace; font-size:.7rem; font-weight:700;
  letter-spacing:.15em; text-transform:uppercase; color:#5A6472; margin:0 0 .4rem; }}
.rule {{ height:1px; background:#D6D0C0; margin:1.1rem 0 1.6rem; }}
.panel {{ background:#FBFAF6; border:1px solid #D6D0C0; padding:1.3rem 1.5rem; margin-bottom:1rem; }}
.verdict {{ font-family:'Work Sans',sans-serif; font-weight:600; font-size:4.4rem; line-height:1.06;
...
st.markdown(
    f'<div class="head">'
    f'<div class="kicker">{html.escape(EYEBROW)}</div>'
    f'<div class="title">Can you hear a hit?</div>'
    f'<div class="meta">{html.escape(DEVELOPER)}</div>'
