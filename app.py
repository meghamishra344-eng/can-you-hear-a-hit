    ...
    for i in idx[0][:3]:
        ...
        if url:
            ...
            st.markdown(
                ...
                unsafe_allow_html=True)
    st.markdown('<p class="kv" style="margin-top:.6rem">Nearest real tracks by audio '
                'profile · number is their Spotify popularity · 30-second previews '
                'via Apple Music · press play to check whether the match holds up</p>', unsafe_allow_html=True)
